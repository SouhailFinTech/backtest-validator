...
SCORING = {'START': 100, 'CRITICAL_PENALTY': -25, 'WARNING_PENALTY': -10, 'THRESHOLDS': {'VALID': 80, 'QUESTIONABLE': 55}}
...
class SmartLookaheadDetector:
    ...
    def analyze(self, code: str, report: ValidationReport):
        try: tree = ast.parse(code)
            ...
            report.add("CRITICAL", "Syntax", f"Invalid Python syntax: {e.msg} (line {e.lineno})")
            return
